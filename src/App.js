            ...
            <ScreenCapture onEndCapture={handleScreenCapture}>
              {({ onStartCapture }) => (
                <div className='flex justify-center flex-col items-center text-center'>
                  <button className="flex flex-row py-2.5 px-5 mr-2 mb-5 text-sm font-medium text-gray-300 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" onClick={onStartCapture}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 items-center mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                      ...
                      <div ref={ref} key={index}>
                        <div className="max-w-sm rounded overflow-hidden shadow-lg mr-5">
                            ...
                            <div className="px-6 pt-4 pb-2 flex flex-row">
                              ...
                              <span className="inline-block rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2 cursor-pointer" onClick={() => getUrlImage(index)}><FacebookIcon size={32} round /></span>
                            </div>
                        </div>
                      </div>
                    )
